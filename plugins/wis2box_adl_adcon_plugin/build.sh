...
# This file is automatically run by wis2box_adl when the plugin is built into a Dockerfile.
...
# Any install steps that will modify things in wis2box_adl's data volume should instead
...
# wis2box_adl will automatically install this python module for you so you should not
